...
namespace CMinusMinusCompiler.Test
{
    ...
    public class Parser_Test
    {
        ...
        public void Parser_HappyPath()
        {
            ...
            TestTools.CompareFileEquality(@"Parser\Expected\HappyPath.txt", CommonTools.OutputFilePaths[0]);
        }
        ...
        public void Parser_InvalidProgram()
        {
            ...
            TestTools.CompareFileEquality(@"Parser\Expected\InvalidProgram.txt", CommonTools.OutputFilePaths[0]);
        }
        ...
        public void Parser_InvalidIdentifierTail()
        {
            ...
            TestTools.CompareFileEquality(@"Parser\Expected\InvalidIdentifierTail.txt", CommonTools.OutputFilePaths[0]);
        }
        ...
        public void Parser_InvalidType()
        {
            ...
            TestTools.CompareFileEquality(@"Parser\Expected\InvalidType.txt", CommonTools.OutputFilePaths[0]);
        }
        ...
        public void Parser_InvalidCompound()
        {
            ...
            TestTools.CompareFileEquality(@"Parser\Expected\InvalidCompound.txt", CommonTools.OutputFilePaths[0]);
        }
        ...
        public void Parser_InvalidRest()
        {
            ...
            TestTools.CompareFileEquality(@"Parser\Expected\InvalidRest.txt", CommonTools.OutputFilePaths[0]);
        }
        ...
        public void Parser_MissingReturn()
        {
            ...
            TestTools.CompareFileEquality(@"Parser\Expected\MissingReturn.txt", CommonTools.OutputFilePaths[0]);
        }
        ...
        public void Parser_InstructorCase1()
        {
            ...
            TestTools.CompareFileEquality(@"Parser\Expected\t31.txt", CommonTools.OutputFilePaths[0]);
        }
        ...
        public void Parser_InstructorCase2()
        {
            ...
            TestTools.CompareFileEquality(@"Parser\Expected\t32.txt", CommonTools.OutputFilePaths[0]);
        }
        ...
        public void Parser_InstructorCase3()
        {
            ...
            TestTools.CompareFileEquality(@"Parser\Expected\t33.txt", CommonTools.OutputFilePaths[0]);
        }
        ...
        public void Parser_InstructorCase4()
        {
            ...
            TestTools.CompareFileEquality(@"Parser\Expected\t34.txt", CommonTools.OutputFilePaths[0]);
        }
        ...
        public void Parser_InstructorCase5()
        {
            ...
            TestTools.CompareFileEquality(@"Parser\Expected\t35.txt", CommonTools.OutputFilePaths[0]);
        }
        ...
        public void Parser_InstructorCase6()
        {
            ...
            TestTools.CompareFileEquality(@"Parser\Expected\t36.txt", CommonTools.OutputFilePaths[0]);
        }
        ...
        public void Parser_InstructorCase7()
        {
            ...
            TestTools.CompareFileEquality(@"Parser\Expected\t37.txt", CommonTools.OutputFilePaths[0]);
        }
        ...
        public void Parser_InstructorCase8()
        {
            ...
            TestTools.CompareFileEquality(@"Parser\Expected\t38.txt", CommonTools.OutputFilePaths[0]);
        }
    }
}
