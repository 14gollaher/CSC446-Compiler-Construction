...
namespace CMinusMinusCompiler.Test
{
    ...
    public class SemanticAnalysis_Test
    {
        ...
        public void SemanticAnalysis_HappyPath()
        {
            ...
            TestTools.CompareFileEquality(@"SemanticAnalysis\Expected\HappyPath.txt", CommonTools.OutputFilePaths[0]);
        }
        ...
        public void SemanticAnalysis_HappyPath2()
        {
            ...
            TestTools.CompareFileEquality(@"SemanticAnalysis\Expected\HappyPath2.txt", CommonTools.OutputFilePaths[0]);
        }
        ...
        public void SemanticAnalysis_Variables()
        {
            ...
            TestTools.CompareFileEquality(@"SemanticAnalysis\Expected\Variables.txt", CommonTools.OutputFilePaths[0]);
        }
        ...
        public void SemanticAnalysis_Constants()
        {
            ...
            TestTools.CompareFileEquality(@"SemanticAnalysis\Expected\Constants.txt", CommonTools.OutputFilePaths[0]);
        }
        ...
        public void SemanticAnalysis_Functions()
        {
            ...
            TestTools.CompareFileEquality(@"SemanticAnalysis\Expected\Functions.txt", CommonTools.OutputFilePaths[0]);
        }
        ...
        public void SemanticAnalysis_Duplicates()
        {
            ...
            TestTools.CompareFileEquality(@"SemanticAnalysis\Expected\Duplicates.txt", CommonTools.OutputFilePaths[0]);
        }
        ...
        public void SemanticAnalysis_UndeclaredVariableLeft()
        {
            ...
            TestTools.CompareFileEquality(@"SemanticAnalysis\Expected\UndeclaredVariableLeft.txt", CommonTools.OutputFilePaths[0]);
        }
        ...
        public void SemanticAnalysis_InstructorCase1()
        {
            ...
            TestTools.CompareFileEquality(@"SemanticAnalysis\Expected\t51.txt", CommonTools.OutputFilePaths[0]);
        }
        ...
        public void SemanticAnalysis_InstructorCase2()
        {
            ...
            TestTools.CompareFileEquality(@"SemanticAnalysis\Expected\t52.txt", CommonTools.OutputFilePaths[0]);
        }
        ...
        public void SemanticAnalysis_InstructorCase3()
        {
            ...
            TestTools.CompareFileEquality(@"SemanticAnalysis\Expected\t53.txt", CommonTools.OutputFilePaths[0]);
        }
        ...
        public void SemanticAnalysis_InstructorCase5()
        {
            ...
            TestTools.CompareFileEquality(@"SemanticAnalysis\Expected\t55.txt", CommonTools.OutputFilePaths[0]);
        }
        ...
        public void SemanticAnalysis_InstructorCase6()
        {
            ...
            TestTools.CompareFileEquality(@"SemanticAnalysis\Expected\t56.txt", CommonTools.OutputFilePaths[0]);
        }
        ...
        public void SemanticAnalysis_InstructorCase7()
        {
            ...
            TestTools.CompareFileEquality(@"SemanticAnalysis\Expected\t57.txt", CommonTools.OutputFilePaths[0]);
        }
        ...
        public void SemanticAnalysis_InstructorCase8()
        {
            ...
            TestTools.CompareFileEquality(@"SemanticAnalysis\Expected\t58.txt", CommonTools.OutputFilePaths[0]);
        }
        ...
        public void SemanticAnalysis_InstructorCase11()
        {
            ...
            TestTools.CompareFileEquality(@"SemanticAnalysis\Expected\test1.txt", CommonTools.OutputFilePaths[0]);
        }
        ...
        public void SemanticAnalysis_InstructorCase12()
        {
            ...
            TestTools.CompareFileEquality(@"SemanticAnalysis\Expected\test2.txt", CommonTools.OutputFilePaths[0]);
        }
        ...
        public void SemanticAnalysis_InstructorCase13()
        {
            ...
            TestTools.CompareFileEquality(@"SemanticAnalysis\Expected\test3.txt", CommonTools.OutputFilePaths[0]);
        }
        ...
        public void SemanticAnalysis_InstructorCase14()
        {
            ...
            TestTools.CompareFileEquality(@"SemanticAnalysis\Expected\test4.txt", CommonTools.OutputFilePaths[0]);
        }
        ...
        public void SemanticAnalysis_InstructorCase15()
        {
            ...
            TestTools.CompareFileEquality(@"SemanticAnalysis\Expected\test5.txt", CommonTools.OutputFilePaths[0]);
        }
        ...
        public void SemanticAnalysis_InstructorCase16()
        {
            ...
            TestTools.CompareFileEquality(@"SemanticAnalysis\Expected\test6.txt", CommonTools.OutputFilePaths[0]);
        }
        ...
        public void SemanticAnalysis_InstructorCase17()
        {
            ...
            TestTools.CompareFileEquality(@"SemanticAnalysis\Expected\test7.txt", CommonTools.OutputFilePaths[0]);
        }
    }
}
