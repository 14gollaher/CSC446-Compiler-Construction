...
namespace CMinusMinusCompiler.Test
{
    ...
    public class LexicalAnalyzer_Test
    {
        ...
        public void LexicalAnalyzer_HappyPath()
        {
            ...
            TestTools.CompareFileEquality(@"LexicalAnalyzer\Expected\HappyPath.txt", CommonTools.OutputFilePath);
        ...
        public void LexicalAnalyzer_Identifiers()
        {
            ...
            TestTools.CompareFileEquality(@"LexicalAnalyzer\Expected\Identifiers.txt", CommonTools.OutputFilePath);
        }
        ...
        public void LexicalAnalyzer_Numbers()
        {
            ...
            TestTools.CompareFileEquality(@"LexicalAnalyzer\Expected\Numbers.txt", CommonTools.OutputFilePath);
        }
        ...
        public void LexicalAnalyzer_Comments()
        {
            ...
            TestTools.CompareFileEquality(@"LexicalAnalyzer\Expected\Comments.txt", CommonTools.OutputFilePath);
        }
        ...
        public void LexicalAnalyzer_Symbols()
        {
            ...
            TestTools.CompareFileEquality(@"LexicalAnalyzer\Expected\Symbols.txt", CommonTools.OutputFilePath);
        }
        ...
        public void LexicalAnalyzer_StringLiterals()
        {
            ...
            TestTools.CompareFileEquality(@"LexicalAnalyzer\Expected\StringLiterals.txt", CommonTools.OutputFilePath);
        }
        ...
        public void LexicalAnalyzer_ReservedWords()
        {
            ...
            TestTools.CompareFileEquality(@"LexicalAnalyzer\Expected\ReservedWords.txt", CommonTools.OutputFilePath);
        }
        ...
        public void LexicalAnaylzer_FullWalkthrough()
        {
            ...
            TestTools.CompareFileEquality(@"LexicalAnalyzer\Expected\FullWalkthrough.txt", CommonTools.OutputFilePath);
        }
        ...
        public void LexicalAnaylzer_InstructorCase1()
        {
            ...
            TestTools.CompareFileEquality(@"LexicalAnalyzer\Expected\Tokens.txt", CommonTools.OutputFilePath);
        }
        ...
        public void LexicalAnaylzer_InstructorCase2()
        {
            ...
            TestTools.CompareFileEquality(@"LexicalAnalyzer\Expected\Tokens2.txt", CommonTools.OutputFilePath);
        }
        ...
        public void LexicalAnaylzer_InstructorCase3()
        {
            ...
            TestTools.CompareFileEquality(@"LexicalAnalyzer\Expected\Tokens3.txt", CommonTools.OutputFilePath);
        }
        ...
        public void LexicalAnaylzer_InstructorCase4()
        {
            ...
            TestTools.CompareFileEquality(@"LexicalAnalyzer\Expected\Tokens4.txt", CommonTools.OutputFilePath);
        }
        ...
        public void LexicalAnaylzer_InstructorCase5()
        {
            ...
            TestTools.CompareFileEquality(@"LexicalAnalyzer\Expected\Tokens5.txt", CommonTools.OutputFilePath);
        }
    }
}
